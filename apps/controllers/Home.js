...
var consultas = {
    clausulas: function(object) {
        if (object.seleccionador === "especialidad")
            ...
            return objeto = {
                $or: {
                    ciudad: object.ciudadela,
                    colonia: object.coloniapad
                }
            };
        }
    }
...
module.exports = {
    ...
    vacio: function(object, req, res) {
        res.render('searchMedic', {}, function(err, html) {
            res.send(html)
        });
    },
    /**
            ...
            case "especialidad":
                models.Usuario.findAll({
                    ...
                    include: [{
                            ...
                            where: consultas.clausulas(object)
                        }, {
                    ...
                    res.render('searchMedic', {
                        medicos: JSON.parse(JSON.stringify(medicos))
                    });
                });
                break;
            case "medico":
