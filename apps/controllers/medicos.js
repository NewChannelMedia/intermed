     ...
     models.Usuario.findOne({
          ...
          include: [{ model: models.DatosGenerales },
            ...
            { model: models.Telefono}
              ...
              console.log(medico['Direccions'][0]['localidad_id']);
                models.Localidad.findOne({

                  where: {

                      id: medico['Direccions'][0]['localidad_id']

                  }

                }).then( function (localidad){

                  data['nombre'] = medico['DatosGenerale']['nombre'];
                  data['localidad'] = localidad.localidad;
                  data['cp'] = localidad.CP;
                  data['correo']  = medico['correo'];
                  data['apellidoP'] = medico['DatosGenerale']['apellidoP'];
                  data['apellidoM'] = medico['DatosGenerale']['apellidoM'];
                  data['telefono'] = medico['Telefonos'][0]['numero'];
                  data['calle'] = medico['Direccions'][0]['calle'];
                  data['calle1'] = medico['Direccions'][0]['calle1'];
                  data['calle2'] = medico['Direccions'][0]['calle2'];
                  data['numeroCalle'] = medico['Direccions'][0]['numero'];

                    models.MedicoEspecialidad.findOne({
 
                  where: {

                      medico_id: medico['Medico']['id']

                  }
                  ,
                  include: 
                  [
                    {model: models.Especialidad, attributes: ['id','especialidad'], required: true}
                  ]

                }).then( function (m_especialidad){

                    data['especialidad_id'] = m_especialidad.especialidad_id;

                    models.Especialidad.findOne({
 
                  where: {

                      id: m_especialidad.especialidad_id
                      ...
                      data['especialidad'] = m_especialidad.especialidad;
