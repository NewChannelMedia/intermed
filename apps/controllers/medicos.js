  ...
  getFeedback: function (object, req, res){
    models.Medico.findOne({
      ...
      .then(function(promedios) {
        models.sequelize.query("SELECT AVG(`satisfaccionGeneral`) AS 'satisfaccionGeneral' FROM `intermed`.`preguntas-medico` where `medico_id` = 1;", { type: models.sequelize.QueryTypes.SELECT})
