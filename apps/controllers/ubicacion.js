...
exports.obtieneCiudades = function(object, req, res) {
  models.Ciudad.findAll({where: {estado_id: object.estado_id}, order: ['ciudad'], attributes: ['id','ciudad']}).then(function(ciudades) {
...
exports.obtieneLocalidades = function(object, req, res) {
  models.Localidad.findAll({where: {estado_id: object.estado_id , ciudad_id: object.ciudad_id}, order: ['localidad'], attributes: ['id','localidad']}).then(function(localidades) {
